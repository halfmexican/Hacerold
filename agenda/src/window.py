...
@Gtk.Template(resource_path='/org/halfmexican/agenda/window.ui')
class AgendaWindow(Gtk.ApplicationWindow):
    __gtype_name__ = 'AgendaWindow'
    ...
    def __init__(self, **kwargs):
        ...
        self.load_json()
        self.set_icon_name('org.halfmexican.agenda')
...
class AboutDialog(Gtk.AboutDialog):
    ...
    def __init__(self, parent):
        ...
        self.props.program_name = 'Agenda'
        self.props.version = "0.1.0"
        self.props.authors = ['José Hunter']
        self.props.copyright = '2022 José Hunter'
        self.props.logo_icon_name = 'org.halfmexican.agenda'
